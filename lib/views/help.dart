                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: const Align(
                            alignment: Alignment.center,
                            child: PlayIconContainer(height: 70, width: 70, hasBorder: true),
                          ),
                        ),
                      ),
                    ),
            ...
            child: Container(
               ...
               child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5.0,),
                  Column(
                    children: List.generate(questions.length, (int index1) => Container(
                      margin: index1 < (questions.length - 1) ? const EdgeInsets.only(bottom: 10.0) : const EdgeInsets.all(0.0),
                      child: Theme(
                        data: ThemeData(
                        ...
                        child: ExpansionTile(
                          trailing: Container(
                            ...
                            width: 30,
                            child: Icon(
                              questions[index1]["isExpanded"] ? Icons.remove : Icons.add,
                            ),
                          ),
                          ...
                          collapsedTextColor: const Color.fromRGBO(102, 102, 102, 1),
                          childrenPadding: const EdgeInsets.only(left: 20.0,right: 20.0, bottom: 10.0),
                          ...
                          children:  List.generate(questions[index1]["answers"].length, (int index2) {
                            return Row(
                              children: [
                                Text(
                                '${index2 + 1}. ',
                                ...
                                Expanded(
                                  child:Text(
                                    questions[index1]["answers"][index2],
                                    style: const TextStyle(
                                      fontSize: 12,
                                    ),
                                  ),
                          ...
                          onExpansionChanged: (bool expanded) {
                            setState(() {
                              questions[index1]["isExpanded"] = expanded;
                            });
                          },
                        ), 
                      ),
